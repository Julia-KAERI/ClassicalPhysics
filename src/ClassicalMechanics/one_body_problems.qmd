...
![일차원 포텐셜](../images/classical%20mechanics/potential/potential.png){#fig-CM_1d_potential width=500}
...
![변위 벡터에 의해 쓸려지는 면적](../images/classical%20mechanics/area_swept/area_swept.png){#fig-CM_area_swept_by_radius_vector width=250}
...
![중심장에서의 경로](../images/classical%20mechanics/central_field_orbit/orbit.png){#fig-CM_central_field_orbin width=500}
...
![케플러 문제에서의 $V_\textrm{eff}$](../images/classical%20mechanics/effective_potential_for_kepler_orbit/effective_potential.png){#fig-CM_effective_potential_for_kepler_problem_1 width=530}
