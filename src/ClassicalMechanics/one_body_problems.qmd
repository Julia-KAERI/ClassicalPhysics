...
$$ {#eq-amplitude_of_steady_solution}

$x_0$ 를 $\omega/\omega_0$ 에 대해 표현하면 @fig-resonance 와 같다. 

![공명 곡선 (Resonance curve)](../images/classical%20mechanics/resonance/resonance.png){#fig-resonance width=340}
...
($b$) @eq-amplitude_of_steady_solution 로부터, $x_0(\omega) = x_0 (\omega_0)/\sqrt{2}$ 가 되도록 하는 $\omega$ 를 찾으면 
...
![일차원 포텐셜](../images/classical%20mechanics/potential/potential.png){#fig-1d_potential width=500}
...
![변위 벡터에 의해 쓸려지는 면적](../images/classical%20mechanics/area_swept/area_swept.png){#fig-area_swept_by_radius_vector width=250}
...
![중심장에서의 경로](../images/classical%20mechanics/central_field_orbit/orbit.png){#fig-central_field_orbin width=500}
...
![케플러 문제에서의 $V_\textrm{eff}$](../images/classical%20mechanics/effective_potential_for_kepler_orbit/effective_potential.png){#fig-effective_potential_for_kepler_problem_1 width=530}
...
![$\varepsilon$ 값에 따른 궤도](../images/classical%20mechanics/keppler_orbit/keppler_orbit.png){#fig-kepler_orbit width=400}
