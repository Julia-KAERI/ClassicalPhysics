...
![실험실 좌표계](../images/classical%20mechanics/frame_and_scattering/frame_and_scattering.png){#fig-reference_system_scattering}
...
![탄성 충돌 후 실험실 좌표계에서의 운동량 벡터](../images/classical%20mechanics/momentum_in_lab_frame/momentum_in_lab_frame.png){#fig-elastic_scattering width=220}
...
![$m_2$ 가 정지해 있을 때의 실험실 좌표계](../images/classical%20mechanics/elastic_scattering_angles/elastic_scatteiing_angles.png){#fig-elastic_scattering_angles_ss width=560}
...
![러더퍼드 산란](../images/classical%20mechanics/rutherford_scattering/rutherford_scattering.png){#fig-rutherford_scattering width=370}
...
보통 우리가 측정하는 것은 $\theta_0$ 가 아닌 $\Theta$ 이다. $\Theta = |\pi - 2 \theta_0|$ 이므로 @eq-rutherford_1 을 $\Theta$ 와 $\rho$ 에 대패 표현하면, 
...
![산란 실험](../images/classical%20mechanics/cross_section/cross_section.png){#fig-scattering_cross_section width=500}
...
![Perpect regid sphere](../images/classical%20mechanics/potential_wall/potential_wall.png){#fig-perfect_rigid_sphere width=350}
...
러더포드 산란단면적 @eq-rutherford_formular 을 증명하라.
