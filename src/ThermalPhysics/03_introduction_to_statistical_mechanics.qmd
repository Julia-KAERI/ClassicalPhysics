...
$${#eq-TD_schroeder_2_39_1}

이다. 운동량 공간에서의 반지름은 총 에너지 $\sum_{i=1}^N \|\bf{p}_i\|^2 = 2mU$ 로부터 구한다. 위 @eq-TD_schroeder_2_39_1 은 다음과 같이 근사시킬 수 있다$^1$.[$^1$ (본인주) @eq-TD_schroeder_2_39_1 에서 @eq-TD_schroeder_2_39 로의 근사는 매우 불편하지만 @eq-TD_schroeder_2_39 자체는 이후 정준앙상블을 배우면서 정확히 구할 수 있다.]{.aside} 
