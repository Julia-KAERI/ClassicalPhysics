...
\begin{tikzpicture}
    ...
    mark=at position 0.5 with {\arrow{>}}}
        ...
        \draw[] (2, 2) node [fill = blue!20, draw = blue, ultra thick, circle, minimum size=4em] {$X$};

        \draw[postaction={decorate}] (5,0)-- node [right] {$Q_l$} (5,1.5) ;
        \draw[postaction={decorate}] (5,2.5)-- node [right] {$Q_h$} (5,4);
        \draw[] (5, 2) node [fill = blue!20, draw = blue, ultra thick, circle, minimum size=4em] {Carnot};
    \end{scope}
\end{tikzpicture}
