...
또한 @eq-EM_electrostatic_potential_energy_by_electric_field 로부터
...
### Green's reciprocal relation {#sec-EM_electrostatics_green_reciprocal_relation}

전하 밀도 $\rho_1$ 에 의한 전기포텐셜 $\phi_1$ 과 전하 밀도 $\rho_2$ 에 의한 전기 포텐셜 $\phi_2$ 를 생각하자. 즉 $\nabla \phi_1 = - \rho_1/\epsilon_0,\, \nabla \phi_2 = - \rho_2\epsilon_0$ 이다. 그렇다면 

$$
\begin{aligned}
U_{12} &= \int_V \rho_1(\bf{r}) \phi_2(\bf{r})\,d^3\bf{r} = \dfrac{1}{4\pi \epsilon_0}\int_V d^3\bf{r}\rho_1(\bf{r})\int_V d^3\bf{r}' \dfrac{\rho_2(\bf{r}')}{\|\bf{r}-\bf{r}'\|} \\[0.3em]
&= \dfrac{1}{4\pi\epsilon_0} \int_V \int_V \dfrac{\rho_1(\bf{r})\rho_2(\bf{r}')}{\|\bf{r}-\bf{r}'\|}\,d^3\bf{r}\,d^3\bf{r}' \\[0.3em]
&= \int_V \rho_2(\bf{r}) \phi_1(\bf{r})\,d^3{\bf{r}} = U_{21}
\end{aligned}
$$ 

즉 다음의 관계가 성립한다.
$$
\int_V \rho_1(\bf{r}) \phi_2(\bf{r})\,d^3\bf{r} = \dfrac{1}{4\pi \epsilon_0} \int_V \int_V \dfrac{\rho_1(\bf{r})\rho_2(\bf{r}')}{\|\bf{r}-\bf{r}'\|}\,d^3\bf{r}\,d^3\bf{r}' = \int_V \rho_2(\bf{r}) \phi_1(\bf{r})\,d^3{\bf{r}}
$${#eq-EM_electrostatics_green_reciprocal_relation}

@eq-EM_electrostatics_green_reciprocal_relation 을 Green's reciprical relation 이라고 한다.
