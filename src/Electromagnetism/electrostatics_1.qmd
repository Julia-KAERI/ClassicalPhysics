...
![그림](../images/Electromagnetism/electrostatics/exr_purcell_1_2/purcell1_2.png){#fig_part2_purcell_1_2 width=200}

위의 그림과같은 전하 배치를 생각하자. 전하는 원점을 중심으로 하는 정삼각형에 위치해 있으며 대칭축은 $y$ 축이다. 
