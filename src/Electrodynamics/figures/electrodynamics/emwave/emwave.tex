...
\begin{tikzpicture}[x=(-15:0.9), y=(90:0.9), z=(-150:1.1),
  ...
  \def\xmax{\nNodes*pi/2*1.01}
  \pgfmathsetmacro\nVectors{(\nVectorsPerNode+1)*\nNodes}
  \def\vE{{\color{Ecol}\boldsymbol{E}}}
  \def\vB{{\color{Bcol}\boldsymbol{B}}}
  ...
  \def\yOffset{\A*1.1}
  \def\zOffset{\A*1.1}
  \draw[axis,very thick,vcol] (\xOffset,\yOffset,-\zOffset) -- ++(\A*0.6,0,0) node[right,align=center] {$\boldsymbol{v}$}; %\\propagation
  \draw[axis,very thick,Ecol]  (\xOffset,\yOffset,-\zOffset) -- ++(0,\A*0.6,0) node[right] {$\boldsymbol{E}$};
  \draw[axis,very thick,Bcol]   (\xOffset,\yOffset,-\zOffset) -- ++(0,0,\A*0.6) node[left] {$\boldsymbol{B}$};
...
\begin{tikzpicture}[x=(-15:0.9), y=(90:0.9), z=(-150:1.1),
  ...
  % VECTOR
  \draw[->,very thick,vcol] (\A*1.1,\A*0.8,0) --++ (\A*0.5,0,0) node[right] {$\boldsymbol{v}$};
...
\begin{tikzpicture}[x=(-15:0.9), y=(90:0.9), z=(-150:1.1),
  ...
  % VECTOR
  \draw[->,very thick,vcol] (\xmax*1.2,\A*0.7,0) --++ (\A*0.5,0,0) node[right] {$\boldsymbol{v}$};
...
\begin{tikzpicture}[x=(-15:1.2), y=(90:1.0), z=(-150:1.0),
  ...
  \def\yOffset{\A*1.2}
  \def\zOffset{\A*1.2}
  \draw[axis] (\xOffset,\yOffset,-\zOffset) -- ++(\A*0.6,0,0) node[right] {$\boldsymbol{k}$};
  \draw[axis] (\xOffset,\yOffset,-\zOffset) -- ++(0,\A*0.6,0) node[right] {$\boldsymbol{E}$};
  \draw[axis] (\xOffset,\yOffset,-\zOffset) -- ++(0,0,\A*0.6) node[above left] {$\boldsymbol{B}$};
  
  % equation
  \node[above right] at (\xOffset,-0.5*\yOffset,4*\zOffset)
    {$\begin{aligned}
      \vE &= \boldsymbol{E_0}\sin(\vk\cdot\boldsymbol{x}-c_0t)\\
      \vB &= \boldsymbol{B_0}\sin(\vk\cdot\boldsymbol{x}-c_0t)\\
      \end{aligned}$};
  \node[below right] at (\xOffset,-0.5*\yOffset,4*\zOffset)
    {$\vE\cdot\vk = 0,\;\; \vB\cdot\vk = 0,\;\; \vB = \dfrac{1}{c_0}\vk\times\vE$};
...
\begin{tikzpicture}[x=(-15:1.2), y=(90:1.0), z=(-150:1.0),
  ...
  \def\vE{{\color{myblue}\boldsymbol{E}}}
  \def\vB{{\color{myred}\boldsymbol{B}}}
  \def\vk{{\hat{\boldsymbol{k}}}}
  ...
  \def\yOffset{\A*1.2}
  \def\zOffset{\A*1.2}
  \draw[axis,black] (\xOffset,\yOffset,-\zOffset) -- ++(\A*0.6,0,0) node[right,align=center] {$\hat{\boldsymbol{k}}$}; %\\propagation
  \draw[axis,myblue]  (\xOffset,\yOffset,-\zOffset) -- ++(0,\A*0.6,0) node[right] {$\boldsymbol{E}$};
  \draw[axis,myred]   (\xOffset,\yOffset,-\zOffset) -- ++(0,0,\A*0.6) node[above left] {$\boldsymbol{B}$};
  
  % equation
  \node[above right] at (\xOffset,-0.5*\yOffset,4*\zOffset)
    {$\begin{aligned}
      \boldsymbol{E} &= {\color{myblue}\boldsymbol{E}_0}\sin(\vk\cdot\boldsymbol{x}-c_0t)\\
      \vB &= {\color{myred} \boldsymbol{B}_0}\sin(\vk\cdot\boldsymbol{x}-c_0t)\\
      \end{aligned}$};
  \node[below right] at (\xOffset,-0.5*\yOffset,4*\zOffset)
    {$\vE\cdot\vk = 0,\;\; \vB\cdot\vk = 0,\;\; \vB = \dfrac{1}{c_0}\vk\times\vE$};
