...
### 정전기 에너지의 의미 {#sec-ED_meaning_of_electrostatic_energy}
...
### 정전기 에너지 비교 {#sec-ED_comparison_of_electrostatic_energy}

자 이제 @eq-ED_total_electrostatic_energy_for_2_point_charge 와 @eq-ED_total_electrostatic_energy_for_charge_distribution 을 비교해보자. $e,\,-e$ 의 전하를 가진 두 입자가 떨어져 있다면 그 전기 포텐셜 에너지는 @eq-ED_total_electrostatic_energy_for_2_point_charge 에 의하면 음수이고 @eq-ED_total_electrostatic_energy_for_charge_distribution 에 의하면 양수이다. 이 차이는 어디서 왔을까?
