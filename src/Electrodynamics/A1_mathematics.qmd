...
## 헬름홀츠 정리 {#sec-ED_MT_Helmholtz_theorem}

- [헬름홀츠 정리](https://julia-kaeri.github.io/MathematicalPhysics/src/vector_calculus/vectorcalculus.html)
...
$$ {#eq-ED_MT_laplace_equation_in_spherical_coordinate}
...
$${#eq-ED_MT_laplace_equation_in_spherical_coordinate_2}
...
$$ {#eq-ED_MT_generator_of_legendre_polymonals}
...
$$ {#eq-ED_MT_orthogonality_of_legendre_polynomial}

$$
P_n(-x) = (-1)^n P_n(x)
$${#eq-ED_MT_parity_of_legendre_polynomial}
...
\end{aligned}
$$ {#eq-ED_MT_definition_of_associated_legendre_polynomial}
...
$$ {#eq-ED_MT_orthogonality_of_associated_legendre_polynomials}

$$
P_l^m(-x) = (-1)^{l-m} P_l^m(x)
$${#eq-ED_MT_parity_of_associated_legendre_polynomials}
...
$$ {#eq-ED_MT_definition_of_spherical_harmomics}
...
&= \delta_{ll'}\delta_{mm'}
\end{aligned}
$$ {#eq-ED_MT_orthogonamity_of_spherical_harmonics}
...
$$ {#eq-ED_MT_similarity_of_spherical_harmonics}
...
\end{aligned}
$$ {#eq-ED_MT_parity_of_spherical_harmonics}
...
\end{aligned}
$$ {#eq-ED_MT_conjugate_of_spherical_harmonics}
...
$$ {#eq-ED_MT_completeness_of_spherical_harmonics}
...
$$ {#eq-ED_MT_addition_theorem_for_spherical_harmonics}

임을 보일 수 있다. 그렇다면 @eq-ED_MT_legendre_expansion 로부터
...
$$ {#eq-ED_MT_spherical_haromics_expansion_of_inverse_vector_difference}
